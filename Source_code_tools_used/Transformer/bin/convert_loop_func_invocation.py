...
from manipulate_pyc import get_co_fn, add_dummy_at_offset, instrument_after_poptop_at_the_end_of_loop
...
def instrument_code_at_offset():
    ...
    lst = instrument_after_poptop_at_the_end_of_loop(co, fn_name)
    print(lst)
