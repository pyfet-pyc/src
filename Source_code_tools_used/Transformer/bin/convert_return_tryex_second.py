...
from manipulate_pyc import get_co_fn, add_dummy_at_offset, convert_return_to_store_try_except_second
...
def instrument_code_at_offset():
    ...
    lst = convert_return_to_store_try_except_second(co, fn_name)
    print(lst)
