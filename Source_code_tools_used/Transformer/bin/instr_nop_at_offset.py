...
from manipulate_pyc import get_co_fn, add_dummy_at_offset, set_at_offset
...
try:
    ...
    print("instr_nop_at_offset [input-pyc] [output-pyc] [function-name] [offset]")
    exit()
...
def instrument_code_at_offset():
    ...
    temp = set_at_offset(co, offset, fn_name, 9) # NOP: 9
    if temp is not None:
        print("Updated!")
