...
from manipulate_pyc import get_co_fn, add_dummy_at_offset, convert_breaks_with_variable_in_except_block
...
def instrument_code_at_offset():
    ...
    lst = convert_breaks_with_variable_in_except_block(co, fn_name)
    print(lst)
