...
from manipulate_pyc import get_co_fn, add_dummy_at_offset, convert_break_if_last_instruction_in_loop
...
def instrument_code_at_offset():
    ...
    lst = convert_break_if_last_instruction_in_loop(co, fn_name)
    print(lst)
