...
from ansible_collections.testns.testcoll.plugins.module_utils.subpkg_with_init import (submod_thingtocall as spwi_submod_thingtocall)
from ansible_collections.testns.testcoll.plugins.module_utils.subpkg_with_init import (cousin_submod_thingtocall as spwi_cousin_submod_thingtocall)
