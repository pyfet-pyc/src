...
# Compiled at: 2022-08-12 15:44:40
...
IGNORE_PROCESSES = {'uploader', 'deleter', 'loggerd', 'logmessaged', 'tombstoned', 'statsd',
 'logcatd', 'proclogd', 'clocksd', 'updated', 'timezoned', 'manage_athenad', 'laikad'} | {k for k, v in managed_processes.items() if not v.enabled if not v.enabled}
